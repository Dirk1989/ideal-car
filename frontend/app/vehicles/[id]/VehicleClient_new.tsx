...
import { Phone, Mail, MapPin, Calendar, Gauge, Fuel, Settings, Check, ArrowLeft, Share2, Heart, ChevronLeft, ChevronRight, X, Tag } from 'lucide-react'
        ...
        <div className="container-custom pt-8 md:pt-12">
          <div className="max-w-4xl mx-auto">
            <div className="rounded-2xl overflow-hidden shadow-2xl">
              ...
              {images.length > 1 && (
                <div className="p-3 md:p-4 flex gap-2 md:gap-3 overflow-x-auto scrollbar-hide bg-white">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <Link 
                      href="/vehicles" 
                      className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 mb-4 transition-colors text-sm"
                    >
                ...
                <div className="text-4xl md:text-5xl font-bold text-blue-600">{formatPrice(vehicle.price)}</div>
              </div>

              {/* Vehicle Specifications */}
              <article className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
                <h2 className="text-2xl md:text-3xl font-bold mb-6">Vehicle Specifications</h2>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg p-8 lg:sticky lg:top-8">
                ...
                <button 
                  ...
                  className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-4 rounded-lg transition-colors mb-4"
                >
                  WhatsApp Seller
                </button>
          ...
          <div className="mt-12 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12 text-center border-2 border-blue-100">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Browse our full selection of quality vehicles to find your perfect match.
            </p>
            <Link 
              href="/vehicles"
